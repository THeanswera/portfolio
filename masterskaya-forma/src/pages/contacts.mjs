...
const body = [
  ...
  <div class="container">
    ${sectionHead({
      label: 'О проекте',
      title: 'Сайт сделан как образец для портфолио',
      text: 'Он показывает, как может работать сайт мастерской мебели: конфигуратор, чертежи, каталог, заявки и документы.',
    })}
    <div class="split">
      <div class="prose">
        <p>
          ...
          на месте этой мастерской может быть ваша.
        </p>
        <p>
