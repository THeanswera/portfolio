...
const sections: { title: string; body: string[] }[] = [
  {
    ...
    body: [
      `Настоящая политика описывает, как ${legal.operator} (далее — «исполнитель») обрабатывает персональные данные посетителей сайта ${site.name}, размещённого по адресу rootlost.ru.`,
